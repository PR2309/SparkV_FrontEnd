          ...
          <main className="chatWindow col-9 px-2 pt-3 container rounded shadow-lg">
            <div className="ai_win container bg-secondary rounded shadow-lg">
              ...
              <div className="container input-container rounded">
                ...
                <button className="history-button btn" onClick={handleAnswer}>
                    <span className="rotate-text2">↔</span>
                  </button>
                ...
                <select id="input_level" name="input_level" className="custom-select" placeholder="--">
                ...
                <div className="input_bar">
                  ...
                  <button className="send-button btn" onClick={handleAnswer}>
